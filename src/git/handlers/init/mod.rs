...
use crate::git::handlers::init::ssh_config::save;
...
pub fn init(config: Config) {
    ...
    if is_work_dir(&config) {
        ...
        save(&config.git.work_credentials.ssh_key, Type::Work);
        ...
        save(&config.git.personal_credentials.ssh_key, Type::Personal);
